...
3. **Frontend**: Add a "Language" dropdown to the Settings/Preferences view (tracked in [issue #59](https://github.com/rlaprelle/Planner/issues/59))
...
| Item | Detail |
|------|--------|
| **Settings/Preferences view** | Phase 5 depends on this existing (tracked in [issue #59](https://github.com/rlaprelle/Planner/issues/59)). The language selector needs a home. |
