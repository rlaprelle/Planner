...
0. Foundation
1. Core CRUD (Projects + Tasks)
2. Quick Capture
3. Evening Clean-up
4. Morning Planning
5. Active Work Session
6. Polish & Stats
...
**Frontend:**
- Evening Clean-up view, two phases:
  - Phase 1 — Deferred items stack: one card at a time, Convert/Defer/Dismiss actions
  ...
  - Phase 2 — Reflection form: energy slider (1-5), mood slider (1-5), reflection notes, completed tasks display
...
**Frontend:**
- Morning Planning view, two-panel layout:
  - Top panel: Task browser with project columns (horizontal scroll), deadline badges (TODAY / THIS WEEK), points display, selection checkboxes
  - Bottom panel: Visual calendar timeline (day's hours), "Add to calendar" auto-places selected tasks
...
**Frontend:**
- Active Work Session view, full-screen focus mode:
  - Task title prominent, project name
  - Countdown timer based on time block duration
